...
const fs = require("fs");
const {ProfileDetails,CountryDetails,EmergencyDetails} = require("../../../PageObjects/Full-Employee-pages/Profile-page")
...
test.beforeEach(async () => {
    ...
    await page.goto("/");
    await searchEmployee(page,'Billal',3);
  ...
  test.describe('Test the Profile Page in the Employee Full Profile as an Employee Role', () => {
